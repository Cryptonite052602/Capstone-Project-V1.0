...
<body class="bg-gray-50">
                    ...
                    <form method="POST" action="" id="manualExportForm" class="manual-export-form">
                        <div class="flex flex-wrap items-center justify-between gap-4">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Check the patients you want to include in the export</p>
                            </div>
                            <div class="flex items-center gap-3">
                                <div class="flex items-center">
                                    <input type="checkbox" id="selectAllPatients" class="patient-checkbox select-all-checkbox" onchange="toggleAllPatients(this)">
                    ...
                    <div class="search-form-container">
                        ...
                        <div class="search-field-group flex flex-col sm:flex-row gap-2 mt-2 sm:mt-0">
                            ...
                            <?php else: ?>
                                ...
                                <a href="existing_info_patients.php<?= $manualSelectMode ? '?manual_select=true&tab=patients-tab' : '?tab=patients-tab' ?>" class="btn-gray min-w-[120px] text-center">
    ...
    <div id="viewModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 modal" style="display: none;">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-7xl max-h-[95vh] overflow-hidden flex flex-col border-2 border-primary">
            <!-- Sticky Header -->
            <div class="p-8 border-b border-primary flex justify-between items-center bg-blue-500 rounded-t-2xl sticky top-0 z-10">
