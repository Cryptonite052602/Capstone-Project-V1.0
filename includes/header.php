                ...
                <div class="flex items-center w-full sm:w-auto">
                    ...
                    <div class="flex items-center space-x-2 mt-5 mr-5 ml-2 border-r border-white pr-6">
                        ...
                        <div class="flex flex-col items-start">
                            <span class="text-[#51E800] text-sm">Welcome Administractor!</span>
            ...
            <nav class="bg-purple-600 text-white shadow-lg sticky top-0 z-50">
                <div class="container mx-auto px-4 py-3 flex justify-between items-center">
                    <div class="flex items-center space-x-2">
                        ...
                        <a href="/community-health-tracker/" class="text-2xl font-bold">CHM Resident Portal</a>
                    </div>
...
<nav class="bg-white text-black shadow-lg sticky top-0 z-50">
    <div class="container mx-auto px-4 py-5 flex justify-between items-center">
        ...
        <div class="flex items-center">
            ...
            <a href="/community-health-tracker/" class="text-2xl font-bold ml-2">CHTMS</a>
        </div>
        ...
        <div class="hidden md:flex items-center">
            <a href="#" onclick="openModal()"
                class="bg-[#FC566C] text-white hover:bg-[#f1233f] px-6 py-3 rounded-lg transition flex items-center gap-2">
    ...
    <div id="mobile-menu" class="mobile-menu md:hidden bg-white border-t">
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="#" onclick="openModal()" 
               class="block bg-[#FC566C] text-white hover:bg-[#f1233f] px-4 py-3 rounded-lg transition text-center mx-1 mt-2 flex items-center justify-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                Book Appointment
