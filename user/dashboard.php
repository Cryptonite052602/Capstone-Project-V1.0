                        ...
                        <form id="appointment-form" method="GET" action="" class="mb-6">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                ...
                                <div class="flex items-end">
                                    <button type="submit" id="find-availability-btn" class="w-full bg-blue-600 text-white py-4 px-4 rounded-full hover:bg-blue-700 transition flex items-center justify-center action-button">
                                        ...
                                        <svg id="loading-spinner" class="animate-spin h-8 w-8 mr-2 hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
